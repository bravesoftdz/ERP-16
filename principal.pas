...
uses
  ...
  Dialogs, ZAbstractDataset, ZDataset, DB, ZAbstractRODataset, ZConnection,
...
begin
     ...
     adoConexion2.User     := 'root' ;
     if trim(tspass1.Text) = '' then
        adoConexion2.Password := 'danae'
     else
       ...
       for iitem := chkservidores.items.count downto 1 do
        ...
        begin
           //try
                   ...
                   adoConexion.User     := 'root' ;
                   if trim(tspass2.Text) = '' then
                      adoConexion.Password :=  'danae'
                   else
