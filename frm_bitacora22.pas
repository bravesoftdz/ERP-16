...
type
  TfrmBitacora2 = class(TForm)
   ds_bitacoradepersonal: TDataSource;
    ...
    gridMaterialesxPartida: TcxGrid;
    ...
    procedure Grid_kTitleBtnClick(Sender: TObject; ACol: Integer;
      Field: TField);
    ...
    procedure dbgrdkMouseMove(Sender: TObject;
    ...
    procedure cxgrdbtblvwGrid1DBTableView2StylesGetContentStyle(
      Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
...
begin
 ...
 { sNumeroFicha.Enabled := False; }
  ...
  begin
   // TcxComboBoxProperties(cxgrdbclmnGrid1DBTableView2Column6).Items.Add(zTipoPersonal.FieldValues['sIdTipoPersonal']);
...
procedure TfrmBitacora2.dbgrdkMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
 ;
end;
...
begin
  tsIdPernoctaEquipo.Color := global_color_entradaERP
end;

procedure TfrmBitacora2.tsIdPernoctaEquipoExit(Sender: TObject);
begin
  tsIdPernoctaEquipo.Color := global_color_salidaERP
end;
...
procedure TfrmBitacora2.Grid_kTitleBtnClick(Sender: TObject;
...
begin
  ...
  sHoraFinal.Color := global_color_salidaERP;
...
begin
  sHoraInicio.Color := global_color_entradaERP;
end;

procedure TfrmBitacora2.sHoraInicioExit(Sender: TObject);
begin
  sHoraInicio.Color := global_color_salidaERP
end;
...
begin
  sPuesto.Color := global_color_entradaERP;
end;

procedure TfrmBitacora2.sPuestoExit(Sender: TObject);
begin
  sPuesto.Color := global_color_salidaERP
end;
...
procedure TfrmBitacora2.cxgrdbtblvwGrid1DBTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
begin
...
procedure TfrmBitacora2.cxgrdbtblvwGrid1DBTableView2DblClick(Sender: TObject);
begin
...
procedure TfrmBitacora2.cxgrdbtblvwGrid1DBTableView2StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
begin
...
procedure TfrmBitacora2.cxgrdbtblvwGrid1DBTableView3StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
begin
  // if (Sender as TrxDBGrid).DataSource.DataSet.State = dsBrowse then
...
begin
  dTiempoExtraf.Color := global_color_entradaERP;
end;

procedure TfrmBitacora2.dTiempoExtrafExit(Sender: TObject);
begin
  dTiempoExtraf.Color := global_color_salidaERP
end;
