...
type
  ...
  CmdDetalleNacionalidades: TButton;
  ...
  dbTipoPersonal: TDBLookupComboBox;
  ...
  BView_RequisicionDescripcion1: TcxGridDBBandedColumn;
    ...
    Label28: TLabel;
    tsSueldoPactado: TDBEdit;
    Label29: TLabel;
    tsAutorizaSueldo: TDBEdit;
    Label30: TLabel;
    tsSolicitaSueldo: TDBEdit;
    ...
    salida: TcxStyle;
    btnTipoPuesto: TButton;
    zqryMovtosRPdSueldoPactado: TFloatField;
    entrada: TcxStyle;
    Nacionalidad: TDBLookupComboBox;
  ...
  procedure tsFichaExit(Sender: TObject);
  procedure dbTipoPersonalEnter(Sender: TObject);
  procedure dbTipoPersonalExit(Sender: TObject);
  ...
  procedure tsPaternoEnter(Sender: TObject);
  procedure tsPaternoExit(Sender: TObject);
  procedure tsMaternoEnter(Sender: TObject);
  procedure tsMaternoExit(Sender: TObject);
  ...
  procedure dbedtiEdadEnter(Sender: TObject);
  procedure dbedtiEdadExit(Sender: TObject);
  procedure CARRERAEnter(Sender: TObject);
  procedure CARRERAExit(Sender: TObject);
  ...
  procedure TipoPersonalEnter(Sender: TObject);
  procedure TipoPersonalExit(Sender: TObject);
  ...
  procedure frmBarra1btnRefreshClick(Sender: TObject);
    ...
    procedure tsSueldoPactadoEnter(Sender: TObject);
    procedure tsSueldoPactadoExit(Sender: TObject);
    procedure tsAutorizaSueldoKeyPress(Sender: TObject; var Key: Char);
    procedure tsAutorizaSueldoEnter(Sender: TObject);
    procedure tsAutorizaSueldoExit(Sender: TObject);
    procedure tsSolicitaSueldoExit(Sender: TObject);
    procedure tsSolicitaSueldoEnter(Sender: TObject);
    ...
    procedure cbNumeroRequisicionEnter(Sender: TObject);
    procedure cbNumeroRequisicionExit(Sender: TObject);
...
uses UTFrmContratarWizard,
  ...
  frmtipopersonal, frm_inteligent;
...
procedure TFrmCatalogoDePostulante.BANCOEnter(Sender: TObject);
begin
  BANCO.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.BANCOExit(Sender: TObject);
begin
  BANCO.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.CARRERAEnter(Sender: TObject);
begin
  CARRERA.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.CARRERAExit(Sender: TObject);
begin
  CARRERA.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.CUENTAEnter(Sender: TObject);
begin
  CUENTA.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.CUENTAExit(Sender: TObject);
begin
  CUENTA.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.CURPEnter(Sender: TObject);
begin
  curp.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.CURPExit(Sender: TObject);
begin
  curp.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.dbedtiEdadEnter(Sender: TObject);
begin
  dbedtiEdad.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.dbedtiEdadExit(Sender: TObject);
begin
  dbedtiEdad.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.dblSexoEnter(Sender: TObject);
begin
  dblSexo.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.dblSexoExit(Sender: TObject);
begin
  dblSexo.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.dbPuestoEnter(Sender: TObject);
begin
  dbPuesto.Style.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.dbPuestoExit(Sender: TObject);
begin
...
procedure TFrmCatalogoDePostulante.dbTipoPersonalEnter(Sender: TObject);
begin
  dbTipoPersonal.Color := global_color_entradaERP;
end;

procedure TFrmCatalogoDePostulante.dbTipoPersonalExit(Sender: TObject);
begin
  dbTipoPersonal.Color := global_color_salidaERP;
end;
...
procedure TFrmCatalogoDePostulante.ESTADOCIVEnter(Sender: TObject);
begin
  ESTADOCIV.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.ESTADOCIVExit(Sender: TObject);
begin
  ESTADOCIV.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.cbNumeroRequisicionEnter(Sender: TObject);
begin

   cbNumeroRequisicion.Style.Color :=  global_color_entradaERP ;

end;

procedure TFrmCatalogoDePostulante.cbNumeroRequisicionExit(Sender: TObject);
begin
   cbNumeroRequisicion.Style.Color :=  global_color_salidaERP;
end;
...
procedure TFrmCatalogoDePostulante.CEDULAEnter(Sender: TObject);
begin
  CEDULA.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.CEDULAExit(Sender: TObject);
begin
  CEDULA.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.NACIMIENTOEnter(Sender: TObject);
begin
  NACIMIENTO.Style.Color := global_color_entradaERP
end;
...
procedure TFrmCatalogoDePostulante.NACIONALIDADEnter(Sender: TObject);
begin
  NACIONALIDAD.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.NACIONALIDADExit(Sender: TObject);
begin
  NACIONALIDAD.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.RFCEnter(Sender: TObject);
begin
  RFC.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.RFCExit(Sender: TObject);
begin
  RFC.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.TipoPersonalEnter(Sender: TObject);
begin
  TipoPersonal.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.TipoPersonalExit(Sender: TObject);
begin
  TipoPersonal.Color := global_color_salidaERP
end;
...
begin
  //Habilitar Secciones
  NxPageControl1.ActivePageIndex := 0;
  NxTabSheet1.TabVisible    := True;
  NxTabSheet2.TabVisible    := True;
...
procedure TFrmCatalogoDePostulante.IMSSEnter(Sender: TObject);
begin
  Imss.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.IMSSExit(Sender: TObject);
begin
  Imss.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.INTERBANCARIAEnter(Sender: TObject);
begin
  INTERBANCARIA.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.INTERBANCARIAExit(Sender: TObject);
begin
  INTERBANCARIA.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.LNACIMIENTOEnter(Sender: TObject);
begin
  LNACIMIENTO.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.LNACIMIENTOExit(Sender: TObject);
begin
  LNACIMIENTO.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.MAILEnter(Sender: TObject);
begin
  Mail.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.MAILExit(Sender: TObject);
begin
  Mail.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.tsAutorizaSueldoEnter(Sender: TObject);
begin
    tsAutorizaSueldo.Color := global_color_entradaERP;
end;

procedure TFrmCatalogoDePostulante.tsAutorizaSueldoExit(Sender: TObject);
begin
    tsAutorizaSueldo.Color := global_color_salidaERP;
end;

procedure TFrmCatalogoDePostulante.tsAutorizaSueldoKeyPress(Sender: TObject;
  var Key: Char);
begin
    if key=#13 then
       tsSolicitaSueldo.SetFocus;
end;

procedure TFrmCatalogoDePostulante.tsCiudadEnter(Sender: TObject);
begin
  tsCiudad.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.tsCiudadExit(Sender: TObject);
begin
...
procedure TFrmCatalogoDePostulante.tsDomicilioEnter(Sender: TObject);
begin
  tsDomicilio.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.tsDomicilioExit(Sender: TObject);
begin
...
procedure TFrmCatalogoDePostulante.tsFichaEnter(Sender: TObject);
begin
  tsFicha.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.tsFichaExit(Sender: TObject);
begin
  tsFicha.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.tsMaternoEnter(Sender: TObject);
begin
  tsMaterno.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.tsMaternoExit(Sender: TObject);
begin
  tsMaterno.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.tsNombreEnter(Sender: TObject);
begin
  tsNombre.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.tsNombreExit(Sender: TObject);
begin
...
procedure TFrmCatalogoDePostulante.tsPaternoEnter(Sender: TObject);
begin
  tsPaterno.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.tsPaternoExit(Sender: TObject);
begin
  tsPaterno.Color := global_color_salidaERP
end;
...
procedure TFrmCatalogoDePostulante.tsSolicitaSueldoEnter(Sender: TObject);
begin
    tsSolicitaSueldo.Color := global_color_entradaERP;
end;

procedure TFrmCatalogoDePostulante.tsSolicitaSueldoExit(Sender: TObject);
begin
    tsSolicitaSueldo.Color := global_color_salidaERP;
end;

procedure TFrmCatalogoDePostulante.tsSueldoPactadoEnter(Sender: TObject);
begin
    tsSueldoPactado.Color := global_color_entradaERP;
end;

procedure TFrmCatalogoDePostulante.tsSueldoPactadoExit(Sender: TObject);
begin
    tsSueldoPactado.Color := global_color_salidaERP;
end;
...
procedure TFrmCatalogoDePostulante.tsTelefonoEnter(Sender: TObject);
begin
  tsTelefono.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.tsTelefonoExit(Sender: TObject);
begin
...
procedure TFrmCatalogoDePostulante.tsTipoSangreEnter(Sender: TObject);
begin
  tsTipoSangre.Color := global_color_entradaERP
end;

procedure TFrmCatalogoDePostulante.tsTipoSangreExit(Sender: TObject);
begin
  tsTipoSangre.Color := global_color_salidaERP
end;
