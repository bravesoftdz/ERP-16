...
begin
  //Bordes
  Rango.Borders[8].lineStyle := Tipo;
  Rango.Borders[7].lineStyle := Tipo;
  Rango.Borders[9].lineStyle := Tipo;
  Rango.Borders[10].lineStyle := Tipo;
  Rango.Borders[11].lineStyle := Tipo;
  Rango.Borders[12].lineStyle := Tipo;

  //Grosor de Linea
  Rango.Borders[8].Weight := Grosor;
  Rango.Borders[7].Weight := Grosor;
  Rango.Borders[9].Weight := Grosor;
  Rango.Borders[10].Weight := Grosor;
  Rango.Borders[11].Weight := Grosor;
  Rango.Borders[12].Weight := Grosor;
end;
end.
