...
uses
  ...
  dxRibbonCustomizationForm, FormAutoScaler, IdIOHandler, IdIOHandlerSocket,
...
uses frm_contratos, frm_deptos, frm_usuarios,
  ...
  frm_ReporteErrores, frmBancos, frm_CambioContrato, frm_SetupPU, UfrmRequisicionesGlobales;//fin de uses
{$R *.dfm}
