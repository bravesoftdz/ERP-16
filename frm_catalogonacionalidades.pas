...
begin
  ...
  begin
    ...
    frmCatalogoDePostulante.NACIONALIDAD.keyValue := qryNacionalidad.FieldValues['iIdNacionalidad'];
    Close;

    global_frmActivo := '';
  end else if global_frmActivo = 'frmEmpleados' then
  begin
    frm_Empleados.tsPais.KeyValue := qryNacionalidad.FieldValues['iIdNacionalidad'];
    frm_Empleados.tsPais.SetFocus;
    Close;
