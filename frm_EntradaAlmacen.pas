...
type
  TfrmEntradaAlmacen = class(TForm)
    ...
    entradasusmovsContrato: TStringField;
    entradasusmoviFolioEntrada: TIntegerField;
    entradasusmovsIdAlmacen: TStringField;
    entradasusmoviFolioMovimiento: TIntegerField;
    entradasusmovsIdTipo: TStringField;
    entradasusmovsNumeroOrden: TStringField;
    entradasusmovdFecha: TDateField;
    entradasusmovsIdUsuario: TStringField;
    entradasusmovmComentarios: TStringField;
    entradasusmovsNombre: TStringField;
    entradasusmovTipo: TStringField;
    entradasusmovsClasificacion: TStringField;
    ...
    entradasusmovsEntrega: TStringField;
    Col_documento: TcxGridDBColumn;
    zqOrdenCompra: TStringField;
    ...
    procedure entradasusmovAfterScroll(DataSet: TDataSet);
 ...
 // nombres.Add('Comentarios/Notas');
  ...
  begin
    ...
    try
      ...
      connection.zCommand.params.ParamByName('Compra').DataType  := ftString;
      connection.zCommand.params.ParamByName('Compra').value     := tsFolioMovimiento.Text;
...
begin
  try
    ...
    begin
      ...
      connection.contrato.Params.ParamByName('Contrato').Value    := entradasusmov.fieldByName('sContrato').Asstring;
...
begin
  ...
  begin
    ...
    FolioCompra.SQL.Add('SELECT a.iFolioPedido as Folio, a.sOrdenCompra as Detalle, a.sNumeroOrden, a.sIdProveedor, ' +
      ...
      'Left Join bitacoradeentrada b On (b.sContrato=a.sContrato And b.iFolioEntrada=a.iFolioPedido)  ' +
...
begin
  ...
  zConsulta.Params.ParamByName('fecha').Value       := entradasusmov.FieldValues['dFecha'];
  zConsulta.Open;
...
procedure TfrmEntradaAlmacen.entradasusmovAfterScroll(DataSet: TDataSet);
var
  inxPos:Integer;
