...
uses
  ...
  RXDBCtrl, ZAbstractRODataset, ZAbstractDataset, ZDataset, UnitExcepciones, udbgrid, unittbotonespermisos, UnitValidaTexto,
  ...
  cxGridCustomTableView, cxGridTableView, cxGridDBTableView, cxGrid, CxGridExportLink, ShellApi,
  FormAutoScaler ;
...
implementation
   uses frm_Inteligent, UInteliDialog, frm_catalogomodulos;
{$R *.dfm}
