...
uses
  ...
  cxTextEdit, cxMemo, cxClasses, cxStyles, dxSkinscxPCPainter, cxCustomData,
...
type
  TfrmSqlManager = class(TForm)
    ...
    GGrid1DBTableView1: TcxGridDBTableView;
    dbgGrid1Level1: TcxGridLevel;
    GridActividades: TcxGrid;
    Col_una: TcxGridDBColumn;
    Col_dos: TcxGridDBColumn;
