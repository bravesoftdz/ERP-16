...
type
  Tfrm_DepsinCuentas = class(TForm)
  frmBarra1: TfrmBarra;
...
var
  frm_DepsinCuentas: Tfrm_DepsinCuentas;
  iFolio : Integer ;
...
uses
  ...
  frmDepositoscias, UInteliDialog;
//fin de uses
...
procedure Tfrm_DepsinCuentas.btnAddClick(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.btnCancelClick(Sender: TObject);
begin
  Zq_DetallesFacturas.Cancel;
  cambio_estado_conceptos;
end;

procedure Tfrm_DepsinCuentas.btnDeleteClick(Sender: TObject);
...
procedure Tfrm_DepsinCuentas.btnEditClick(Sender: TObject);
begin
  if (zQEgresos.FieldByName('CFDI_sEstado').AsString = '') or (zQEgresos.FieldByName('CFDI_sEstado').AsString = 'SIN TIMBRE') or (zQEgresos.FieldByName('CFDI_sEstado').AsString = null) Then
    begin
      if zq_DetallesFacturas.RecordCount > 0 then
...
procedure Tfrm_DepsinCuentas.btnPostClick(Sender: TObject);
var
  sum, SumaIVA : Double;
  estado : String;
begin
...
procedure Tfrm_DepsinCuentas.btnPrinterClick(Sender: TObject);
begin
  //if cxGrid1Level1.GridView = DBGrid1 then
    Visualizar_Factura_Timbrada;
end;

procedure Tfrm_DepsinCuentas.btnCfdiClick(Sender: TObject);
Var
...
procedure Tfrm_DepsinCuentas.btAplicarClick(Sender: TObject);
Var
...
procedure Tfrm_DepsinCuentas.Canceladas1Click(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.cmbmesesEnter(Sender: TObject);
begin
  cmbmeses.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.cmbmesesExit(Sender: TObject);
begin
  cmbmeses.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.cmbmesesKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then dbEstado.SetFocus;
end;

procedure Tfrm_DepsinCuentas.IrACompaniasClick(Sender: TObject);
begin
  if zQEgresos.State IN [dsEdit, dsInsert] then
  begin
    Application.CreateForm(Tfrm_Companias, frm_Companias);
  //  bandera_formulario := 'frm_Depositosias';
...
procedure Tfrm_DepsinCuentas.IrAProyectosClick(Sender: TObject);
begin
  if zQEgresos.State IN [dsEdit, dsInsert] then
  begin
...
procedure Tfrm_DepsinCuentas.cxButton1Click(Sender: TObject);
begin
  if zQEgresos.State IN [dsEdit, dsInsert] then
  begin
...
procedure Tfrm_DepsinCuentas.cxButton2Click(Sender: TObject);
begin
  if zQEgresos.State IN [dsEdit, dsInsert] then
  begin
...
procedure Tfrm_DepsinCuentas.PrecioDivisaEnter(Sender: TObject);
begin
  PrecioDivisa.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.PrecioDivisaExit(Sender: TObject);
begin
  PrecioDivisa.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.PrecioDivisaKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then DBEdit7.SetFocus;
end;

procedure Tfrm_DepsinCuentas.dbCompaniaEnter(Sender: TObject);
begin
  dbCompania.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.dbCompaniaExit(Sender: TObject);
begin
  dbCompania.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.dbCompaniaKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then dbProyecto.SetFocus;
end;

procedure Tfrm_DepsinCuentas.dbCompaniaPropertiesCloseUp(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.DBEdit2Enter(Sender: TObject);
begin
  DBEdit2.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.DBEdit2Exit(Sender: TObject);
begin
  DBEdit2.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.DBEdit2KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then DBEdit3.SetFocus;
end;

procedure Tfrm_DepsinCuentas.DBEdit3Enter(Sender: TObject);
begin
  DBEdit3.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.DBEdit3Exit(Sender: TObject);
begin
  DBEdit3.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.DBEdit3KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then DBMemo2.SetFocus
end;

procedure Tfrm_DepsinCuentas.DBEdit4Enter(Sender: TObject);
begin
  DBEdit4.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.DBEdit4Exit(Sender: TObject);
begin
  DBEdit4.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.DBEdit4KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then DBEdit5.SetFocus;
end;

procedure Tfrm_DepsinCuentas.DBEdit5Enter(Sender: TObject);
begin
  DBEdit5.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.DBEdit5Exit(Sender: TObject);
begin
  DBEdit5.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.DBEdit5KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then dDivisa.SetFocus;
end;

procedure Tfrm_DepsinCuentas.DBEdit7Enter(Sender: TObject);
begin
  DBEdit7.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.DBEdit7Exit(Sender: TObject);
begin
  DBEdit7.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.DBEdit7KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then DBEdit4.SetFocus;
end;

procedure Tfrm_DepsinCuentas.dbEstadoEnter(Sender: TObject);
begin
  dbEstado.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.dbEstadoExit(Sender: TObject);
begin
  dbEstado.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.dbEstadoKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then tdFechaExp.SetFocus;
end;

procedure Tfrm_DepsinCuentas.dbFechaRecepcionEnter(Sender: TObject);
begin
  dbFechaRecepcion.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.dbFechaRecepcionExit(Sender: TObject);
begin
  dbFechaRecepcion.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.dbFechaRecepcionKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then tdFecha.SetFocus;
end;

procedure Tfrm_DepsinCuentas.dbiFolioEnter(Sender: TObject);
begin
  dbiFolio.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.dbiFolioExit(Sender: TObject);
begin
  dbiFolio.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.dbIvaKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then tsReferencia.SetFocus;
end;

procedure Tfrm_DepsinCuentas.DBMemo2Enter(Sender: TObject);
begin
  DBMemo2.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.DBMemo2Exit(Sender: TObject);
begin
  DBMemo2.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.DBMemo2KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then DBEdit2.SetFocus;
end;

procedure Tfrm_DepsinCuentas.DBMemo2PropertiesCloseUp(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.dbProyectoEnter(Sender: TObject);
begin
  dbProyecto.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.dbProyectoExit(Sender: TObject);
begin
  dbProyecto.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.dDivisaEnter(Sender: TObject);
begin
  dDivisa.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.dDivisaExit(Sender: TObject);
begin
  dDivisa.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.dDivisaKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then PrecioDivisa.SetFocus;
end;

procedure Tfrm_DepsinCuentas.dDivisaPropertiesCloseUp(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.dxVentasEmpleadosClick(Sender: TObject);
begin
    qryConsultaF.Active := False ;
    qryConsultaF.SQL.Clear ;
    qryConsultaF.SQL.Add('select i.dIva,i.sTipoMovimiento, i.dFechaFactura, c.sRazonSocial, i.iFolio, i.dImporteTotal, i.dIdFecha, f.sNombre, ' +
...
procedure Tfrm_DepsinCuentas.edtFolioFiscalEnter(Sender: TObject);
begin
  edtFolioFiscal.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.edtFolioFiscalExit(Sender: TObject);
begin
  edtFolioFiscal.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.Visualizar_Factura_Timbrada;
var
  i:integer;
  Qry: TZQuery;
  Marca : TBookmark;
...
procedure Tfrm_DepsinCuentas.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action := cafree ;
end;

procedure Tfrm_DepsinCuentas.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tfrm_DepsinCuentas.FormShow(Sender: TObject);
var
...
procedure Tfrm_DepsinCuentas.frmBarra1btnAddClick(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.frmBarra1btnCancelClick(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.frmBarra1btnDeleteClick(Sender: TObject);
Var
  Marca2 : TBookmark;
begin
...
procedure Tfrm_DepsinCuentas.frmBarra1btnEditClick(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.frmBarra1btnExitClick(Sender: TObject);
begin
  frmBarra1.btnExitClick(Sender);
  close;
end;

procedure Tfrm_DepsinCuentas.frmBarra1btnPostClick(Sender: TObject);
Var
  Marca : TBookmark;
  sMensaje : string;
  maximo: Integer;
...
procedure Tfrm_DepsinCuentas.frmBarra1btnRefreshClick(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.frxReport1GetValue(const VarName: string;var Value: Variant);
Var
  Valor: Real;
begin
  Valor := 0;
...
procedure Tfrm_DepsinCuentas.frx_ReporteGetValue(const VarName: string;var Value: Variant);
begin
...
procedure Tfrm_DepsinCuentas.grid_facturasKeyDown(Sender: TObject;var Key: Word; Shift: TShiftState);
begin
  Panel.Visible := False ;
end;

procedure Tfrm_DepsinCuentas.grid_facturasKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  Panel.Visible := False ;
end;

procedure Tfrm_DepsinCuentas.Grid_facturasStylesGetContentStyle(
...
procedure Tfrm_DepsinCuentas.ImprimirFactura1Click(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.ImprimirFacturaATechnology1Click(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.IngresosxCia1Click(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.NxPageControl1Change(Sender: TObject);
begin
  chkAplicacuadre.Checked := False;
end;

procedure Tfrm_DepsinCuentas.otal1Click(Sender: TObject);
begin
  qryConsultaF.Active := False ;
  qryConsultaF.SQL.Clear ;
  qryConsultaF.SQL.Add('select i.dIva,i.sTipoMovimiento, i.dFechaFactura, c.sRazonSocial, i.iFolio, i.dImporteTotal, i.dIdFecha, f.sNombre, ' +
...
procedure Tfrm_DepsinCuentas.Pagadas1Click(Sender: TObject);
begin
  qryConsultaF.Active := False ;
  qryConsultaF.SQL.Clear ;
  qryConsultaF.SQL.Add('select i.dIva,i.sTipoMovimiento, i.dFechaFactura, c.sRazonSocial, i.iFolio, i.dImporteTotal, i.dIdFecha, f.sNombre, ' +
...
procedure Tfrm_DepsinCuentas.ParcialidadesClick(Sender: TObject);
Var
...
procedure Tfrm_DepsinCuentas.Pendientes1Click(Sender: TObject);
begin
  zQEgresos.Refresh ;
  qryConsultaF.Active := False ;
  qryConsultaF.SQL.Clear ;
...
procedure Tfrm_DepsinCuentas.PorFechas1Click(Sender: TObject);
begin
  qryConsulta.Active := False ;
...
procedure Tfrm_DepsinCuentas.PorProyecto1Click(Sender: TObject);
begin
...
procedure Tfrm_DepsinCuentas.qryParcPagosAfterCancel(DataSet: TDataSet);
begin
  cambio_estado_pagos;
end;

procedure Tfrm_DepsinCuentas.qryParcPagosAfterEdit(DataSet: TDataSet);
begin
  cambio_estado_pagos;
end;

procedure Tfrm_DepsinCuentas.qryParcPagosAfterInsert(DataSet: TDataSet);
var
  subtotal, iva : Double ;
begin
...
procedure Tfrm_DepsinCuentas.qryParcPagosAfterPost(DataSet: TDataSet);
begin
  cambio_estado_pagos;
end;

procedure Tfrm_DepsinCuentas.qryParcPagosBeforeCancel(DataSet: TDataSet);
begin
  cambio_estado_pagos;
end;

procedure Tfrm_DepsinCuentas.qryParcPagosBeforePost(DataSet: TDataSet);
begin
...
procedure Tfrm_DepsinCuentas.qryParcPagosCalcFields(DataSet: TDataSet);
begin
  qryParcPagos.FieldByName('Totalp').AsFloat := qryParcPagos.FieldByName('dImporte').AsFloat + qryParcPagos.fieldbyname('dIva').AsFloat;
end;

procedure Tfrm_DepsinCuentas.ReporteFotograficoBeforeDelete(DataSet: TDataSet);
begin
  if zqEgresos.RecordCount = 0 then abort;
end;

procedure Tfrm_DepsinCuentas.ReporteFotograficoBeforeEdit(DataSet: TDataSet);
begin
  if zqEgresos.RecordCount = 0 then abort;
end;

procedure Tfrm_DepsinCuentas.ReporteFotograficoBeforeInsert(DataSet: TDataSet);
begin
  if zqEgresos.RecordCount = 0 then abort;
end;

procedure Tfrm_DepsinCuentas.sObservacionesEnter(Sender: TObject);
begin
  sObservaciones.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.sObservacionesExit(Sender: TObject);
begin
  sObservaciones.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sAcreedorEnter(Sender: TObject);
begin
  tAddenda_sAcreedor.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sAcreedorExit(Sender: TObject);
begin
  tAddenda_sAcreedor.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sAcreedorKeyPress(Sender: TObject;var Key: Char);
begin
  if key = #13 then tAddenda_sEntrada.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tAddenda_sContratoEnter(Sender: TObject);
begin
  tAddenda_sContrato.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sContratoExit(Sender: TObject);
begin
  tAddenda_sContrato.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sContratoKeyPress(Sender: TObject;var Key: Char);
begin
  if key = #13 then tAddenda_sOSurtimiento.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tAddenda_sEjercicioEnter(Sender: TObject);
begin
  tAddenda_sEjercicio.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sEjercicioExit(Sender: TObject);
begin
  tAddenda_sEjercicio.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sEjercicioKeyPress(Sender: TObject;var Key: Char);
begin
  if key = #13 then tAddenda_sContrato.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tAddenda_sEntradaEnter(Sender: TObject);
begin
  tAddenda_sEntrada.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sEntradaExit(Sender: TObject);
begin
  tAddenda_sEntrada.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sEntradaKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then tAddenda_sVURegion.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tAddenda_sFichaEEnter(Sender: TObject);
begin
  tAddenda_sFichaE.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sFichaEExit(Sender: TObject);
begin
  tAddenda_sFichaE.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sFichaEKeyPress(Sender: TObject;var Key: Char);
begin
  if key = #13 then tAddenda_sFichaF.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tAddenda_sFichaFEnter(Sender: TObject);
begin
  tAddenda_sFichaF.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sFichaFExit(Sender: TObject);
begin
  tAddenda_sFichaF.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sFichaFKeyPress(Sender: TObject;var Key: Char);
begin
  if key = #13 then tAddenda_sMoneda.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tAddenda_sMonedaEnter(Sender: TObject);
begin
  tAddenda_sMoneda.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sMonedaExit(Sender: TObject);
begin
  tAddenda_sMoneda.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sMonedaKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then tAddenda_sEjercicio.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tAddenda_sNEstimacionEnter(Sender: TObject);
begin
  tAddenda_sNEstimacion.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sNEstimacionExit(Sender: TObject);
begin
  tAddenda_sNEstimacion.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sNEstimacionKeyPress(Sender: TObject;var Key: Char);
begin
  if key = #13 then tAddenda_sAcreedor.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tAddenda_sOSurtimientoEnter(Sender: TObject);
begin
  tAddenda_sOSurtimiento.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sOSurtimientoExit(Sender: TObject);
begin
  tAddenda_sOSurtimiento.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sOSurtimientoKeyPress(Sender: TObject;var Key: Char);
begin
  if key = #13 then tAddenda_sNEstimacion.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tAddenda_sVURegionEnter(Sender: TObject);
begin
  tAddenda_sVURegion.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sVURegionExit(Sender: TObject);
begin
  tAddenda_sVURegion.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tAddenda_sVURegionKeyPress(Sender: TObject;var Key: Char);
begin
  if key = #13 then tAddenda_sFichaE.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tdFechaKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then tmDescripcion.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tmDescripcionEnter(Sender: TObject);
begin
  tmDescripcion.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tmDescripcionExit(Sender: TObject);
begin
  tmDescripcion.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tmDescripcionKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure Tfrm_DepsinCuentas.tsReferenciaEnter(Sender: TObject);
begin
  tsReferencia.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tsReferenciaExit(Sender: TObject);
begin
  tsReferencia.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tsReferenciaKeyPress(Sender: TObject;var Key: Char);
begin
  if key = #13 then cmbmeses.SetFocus;
end;

procedure Tfrm_DepsinCuentas.tdFechaEnter(Sender: TObject);
begin
  tdFecha.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tdFechaExit(Sender: TObject);
begin
  tdFecha.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tdFechaExpEnter(Sender: TObject);
begin
  tdFechaExp.Style.Color := global_color_entradaERP
end;

procedure Tfrm_DepsinCuentas.tdFechaExpExit(Sender: TObject);
begin
  tdFechaExp.Style.Color := global_color_salidaERP
end;

procedure Tfrm_DepsinCuentas.tdFechaExpKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then dbFechaRecepcion.SetFocus;
end;


procedure Tfrm_DepsinCuentas.tdFechaFinalExit(Sender: TObject);
 begin
   Memo_Log.Lines.Add('Cargando las facturas');
...
procedure Tfrm_DepsinCuentas.zQEgresosAfterScroll(DataSet: TDataSet);
begin
  if IsOpenE then
  begin
    if zQEgresos.RecordCount  > 0 then
...
procedure Tfrm_DepsinCuentas.zQEgresosCalcFields(DataSet: TDataSet);
begin
  zQEgresos.FieldByName('Total').AsFloat := zQEgresos.FieldByName('dImportetotal').AsFloat + zQEgresos.FieldByName('dIva').AsFloat ;
end;

procedure Tfrm_DepsinCuentas.zQEgresossTipoMovimientoChange(Sender: TField);
begin
  if zQEgresossTipoMovimiento.Text = 'DEPOSITO' then
    zQEgresos.FieldByName('sIdArea').AsString := 'XYZ' ;
end;

procedure Tfrm_DepsinCuentas.zq_DetallesFacturasCalcFields(DataSet: TDataSet);
begin
...
Function Tfrm_DepsinCuentas.Tamanyo (Archivo : String): Real;
Var
  Busca : TsearchRec;
Begin
  ...
  Else Result:=0;
End;
procedure Tfrm_DepsinCuentas.cambio_estado;
begin
  if zQEgresos.State in [dsInsert] then
  begin
...
procedure Tfrm_DepsinCuentas.insertar_valores;
begin
  ...
  zqEgresos.FieldByName('sIdNumeroCuenta').AsString     := 'SIN CUENTA' ;
...
procedure Tfrm_DepsinCuentas.guardar_kardex;
begin
  // Actualizo Kardex del Sistema ....
  connection.zCommand.Active := False ;
  connection.zCommand.SQL.Clear ;
...
procedure Tfrm_DepsinCuentas.cambio_estado_conceptos;
begin
  if zq_DetallesFacturas.State in [dsInsert,dsEdit] then
  begin
...
procedure Tfrm_DepsinCuentas.previsualizar;
Var
  Qry, QryConceptos: TZQuery;
  IdRegistro: String;
  i, x, Encontrados, id: Integer;
...
begin
  ...
  Try
    ...
    Factura.Propiedades.Moneda := dDivisa.EditValue;
	  ...
	  Factura.Propiedades.NumeroDeCuenta := 'SIN CUENTA' ;
...
procedure Tfrm_DepsinCuentas.cambio_estado_pagos;
begin
...
procedure Tfrm_DepsinCuentas.EnviarMensaje(Mensaje, Ip: String);
begin
...
procedure Tfrm_DepsinCuentas.Tablero;
var
  Qry: TZReadOnlyQuery;
begin
