...
begin
  if ZCatErrores.State in [dsInsert, dsEdit] then begin
    ...
    mniEditar1.Enabled    := True  ;
    mniRegistrar1.Enabled := False ;
    mniCan1.Enabled       := False ;
...
begin
  if ZCatErrores.RecordCount > 0 then begin
    ...
    mniEditar1.Enabled    := False ;
    mniRegistrar1.Enabled := True ;
    mniCan1.Enabled       := True ;
  end;
end;
...
procedure TfrmCatalogoErrores.mniCan1Click(Sender: TObject);
begin
  frmBarra1.btnCancel.Click ;
end;

procedure TfrmCatalogoErrores.mniEditar1Click(Sender: TObject);
begin
  frmBarra1.btnEdit.Click ;
end;

procedure TfrmCatalogoErrores.mniEliminar1Click(Sender: TObject);
begin
 frmBarra1.btnDelete.Click ;
end;

procedure TfrmCatalogoErrores.mniExportarExcel1Click(Sender: TObject);
 Var
  rutaArchivo : string;
  respuesta   : Integer ;
  begin
    ...
    begin
      ...
      ExportGridToExcel(rutaArchivo, cxGridCatErrores);
...
procedure TfrmCatalogoErrores.mniRefresh1Click(Sender: TObject);
begin
  frmBarra1.btnRefresh.Click ;
end;

procedure TfrmCatalogoErrores.mniRegistrar1Click(Sender: TObject);
begin
  frmBarra1.btnPost.Click;
end;

procedure TfrmCatalogoErrores.mniSalir1Click(Sender: TObject);
begin
  close ;
end;
