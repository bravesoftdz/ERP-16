...
type
  TfrmConfigAcceso = class(TForm)
    ...
    lbUsurio: TLabel;
    lbServidor: TLabel;
    grid_configIdiomaDBTableView1: TcxGridDBTableView;
    grid_configIdiomaLevel1: TcxGridLevel;
    grid_configIdioma: TcxGrid;
    Grid__colId: TcxGridDBColumn;
    Grid__colIdioma: TcxGridDBColumn;
    Grid__colusuario: TcxGridDBColumn;
    Grid__colServidor: TcxGridDBColumn;
    Grid__colContrasena: TcxGridDBColumn;
    Grid__colseleccionarBD: TcxGridDBColumn;
    Grid__colPuerto: TcxGridDBColumn;
...
begin
   ...
   Salir1.Enabled := True ;
   BotonPermiso.permisosBotones(frmBarra1);
   grid_configIdioma.Enabled := True;
   sOpcion := '';
end;
