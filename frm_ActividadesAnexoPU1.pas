...
type
  TfrmActividadesAnexoPU = class(TForm)
    ...
    GdbgcxGridPu: TcxGridDBTableView;
    ...
    TSdMontoDLL: TDBEdit;
    TSdMontoMN: TDBEdit;
    TSsEspecificacion: TDBEdit;
    dbsIdFase: TDBLookupComboBox;
    TSsActividadAnterior: TDBEdit;
    cblExtraordinario: TDBComboBox;
    TSsMedida: TDBEdit;
    TSsNumeroActividad: TDBEdit;
    cblCalculo: TDBComboBox;
    tiColores: TColorBox;
    TSdPonderado: TDBEdit;
    cbiColor: TDBComboBox;
    pbprogreso: TProgressBar;
    Panel3: TPanel;
    frmBarra1: TfrmBarra;
    chkItemOrden: TCheckBox;
    chkCalculaWbs: TCheckBox;
    TSiItemOrden: TDBEdit;
    cbsTipoAnexo: TDBComboBox;
    NxTabSheet3: TNxTabSheet;
    tNewGroupBox3: tNewGroupBox;
    cbbcmbPersonal: TComboBox;
    ...
    ti5: TEdit;
    tipind1: TEdit;
    tipfinanciamiento: TEdit;
    tiputilidad: TEdit;
    tipca: TEdit;
    tipotros: TEdit;
    titxcd: TEdit;
    titxind1: TEdit;
    titxfinanciamiento: TEdit;
    titxUtilidad: TEdit;
    titxca: TEdit;
    titxotros: TEdit;
    tipu: TEdit;
    ...
    BitBtn1: TBitBtn;
    RxDBGrid1: TRxDBGrid;
    NxTabSheet10: TNxTabSheet;
    tNewGroupBox11: tNewGroupBox;
    Label27: TLabel;
    Label28: TLabel;
    RxDBGrid2: TRxDBGrid;
    NxTabSheet11: TNxTabSheet;
    tNewGroupBox12: tNewGroupBox;
    RxDBGrid3: TRxDBGrid;
    ComboBox2: TComboBox;
    BitBtn2: TBitBtn;
    NxTabSheet12: TNxTabSheet;
    tNewGroupBox13: tNewGroupBox;
    RxDBGrid4: TRxDBGrid;
    NxTabSheet13: TNxTabSheet;
    tNewGroupBox14: tNewGroupBox;
    RxDBGrid5: TRxDBGrid;
    ComboBox3: TComboBox;
    BitBtn3: TBitBtn;
    NxTabSheet14: TNxTabSheet;
    RxDBGrid6: TRxDBGrid;
    Panel6: TPanel;
    Label29: TLabel;
    Label30: TLabel;
    ...
    Edit17: TEdit;
    CheckBox3: TCheckBox;
    tddxLayoutControl1Group_Root: TdxLayoutGroup;
...
begin
  ...
  begin
    ActividadesxAnexo.SQL.Text := 'Select *, SubStr(mDescripcion, 1, 255) as sDescripcion from actividadesxanexo ' +
      'Where sContrato = :contrato And sIdConvenio = :Convenio and sTipoAnexo =:Anexo ' +
      'Order By iitemorden';
  end;
...
procedure TfrmActividadesAnexoPU.ActividadesxAnexoCalcFields(
  DataSet: TDataSet);
begin
...
procedure TfrmActividadesAnexoPU.BtnFasesClick(Sender: TObject);
var
  myForm: TForm;
  GridDetallePartida: TRxDBGrid;
  zDSDetallePartida: tDataSource;
...
begin
  ...
  begin
    ...
    Connection.QryBusca.Filtered := False;
    connection.qryBusca.SQL.Clear;
    If Connection.configuracion.fieldValues['sAlmcon'] = 'CONTRATO' Then
     begin
      connection.qryBusca.SQL.Add('select i.sIdInsumo, substr(i.mDescripcion,1,255) as sDescripcion, i.dVentaMN, i.dVentaDLL, i.sMedida from insumos ' +
